...
<body>
	...
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=d0d0fbca3dffd242f8115b3ee25c2053&libraries=services,clusterer,drawing"></script>
	
	<!-- kakao 지도 api -->
	<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=d0d0fbca3dffd242f8115b3ee25c2053"></script>
